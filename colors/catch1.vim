" Vim color file
" catch1
" Created by Jens Pauwels with ThemeCreator (https://github.com/mswift42/themecreator)
...
let s:bg3="#9b9b9b"
let s:bg4="#8d8d8d"
let s:keyword="#a4a9bf"
let s:builtin="#d11188"
let s:const= "#d4d4d4"
...
exe 'hi TabLineSel   guifg='s:fg' guibg='s:func
