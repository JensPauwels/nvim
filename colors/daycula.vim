" -----------------------------------------------------------------------------
" Name:         Daycula
" Description:  A dark, vivid and calming colorscheme
" Author:       Muh. Ghifari Taqiuddin
" Website:      https://github.com/ghifarit53/daycula-vim/
" License:      MIT
" -----------------------------------------------------------------------------
...
"
let s:palette = {
          \ 'black':      ['#070813',   '237',  'DarkGrey'],
          \ 'bg0':        ['#1a1d45',   '235',  'Black'],
          \ 'bg1':        ['#1f2252',   '236',  'DarkGrey'],
          \ 'bg2':        ['#24285e',   '236',  'DarkGrey'],
          \ 'bg3':        ['#292d6b',   '237',  'DarkGrey'],
          \ 'bg4':        ['#2e3278',   '237',  'Grey'],
          \ 'bg_red':     ['#ff60ae',   '203',  'Red'],
          \ 'diff_red':   ['#371123',   '52',   'DarkRed'],
          \ 'bg_green':   ['#8bc76e',   '107',  'Green'],
          \ 'diff_green': ['#1d2a17',   '22',   'DarkGreen'],
          \ 'bg_blue':    ['#7f8ef5',   '110',  'Blue'],
          \ 'diff_blue':  ['#171a2c',   '17',   'DarkBlue'],
          \ 'fg':         ['#d7b7bb',   '250',  'White'],
          \ 'red':        ['#ff4ea5',   '203',  'Red'],
          \ 'cyan':     ['#6cac99',   '215',  'Cyan'],
          \ 'yellow':     ['#eaad64',   '179',  'Yellow'],
          \ 'green':      ['#7eb564',   '107',  'Green'],
          \ 'blue':       ['#7a89ec',   '110',  'Blue'],
          \ 'purple':     ['#b66cdc',   '176',  'Magenta'],
          \ 'grey':       ['#30357F',   '246',  'LightGrey'],
          \ 'none':       ['NONE',      'NONE', 'NONE']
          \ }
" }}}
" Function: {{{
...
if s:configuration.enable_italic
  ...
  call s:HL('Identifier', s:palette.cyan, s:palette.none, 'italic')
  call s:HL('Constant', s:palette.cyan, s:palette.none, 'italic')
else
...
call s:HL('Tag', s:palette.cyan, s:palette.none)
...
call s:HL('markdownH2', s:palette.cyan, s:palette.none, 'bold')
...
call s:HL('htmlH2', s:palette.cyan, s:palette.none, 'bold')
...
highlight! link cssClassNameDot Cyan
...
highlight! link cssUnitDecorators Cyan
...
highlight! link scssSelectorChar Cyan
...
highlight! link javascriptDotNotation Cyan
highlight! link javascriptGlobalArrayDot Cyan
highlight! link javascriptGlobalBigIntDot Cyan
highlight! link javascriptGlobalDateDot Cyan
highlight! link javascriptGlobalJSONDot Cyan
highlight! link javascriptGlobalMathDot Cyan
highlight! link javascriptGlobalNumberDot Cyan
highlight! link javascriptGlobalObjectDot Cyan
highlight! link javascriptGlobalPromiseDot Cyan
highlight! link javascriptGlobalRegExpDot Cyan
highlight! link javascriptGlobalStringDot Cyan
highlight! link javascriptGlobalSymbolDot Cyan
highlight! link javascriptGlobalURLDot Cyan
...
highlight! link typescriptDotNotation Cyan
highlight! link typescriptGlobalNumberDot Cyan
highlight! link typescriptGlobalStringDot Cyan
highlight! link typescriptGlobalArrayDot Cyan
highlight! link typescriptGlobalObjectDot Cyan
highlight! link typescriptGlobalSymbolDot Cyan
highlight! link typescriptGlobalMathDot Cyan
highlight! link typescriptGlobalDateDot Cyan
highlight! link typescriptGlobalJSONDot Cyan
highlight! link typescriptGlobalRegExpDot Cyan
highlight! link typescriptGlobalPromiseDot Cyan
highlight! link typescriptGlobalURLDot Cyan
...
call s:HL('semshiUnresolved', s:palette.cyan, s:palette.none, 'undercurl')
...
highlight! link goPredefinedIdentifiers CyanItalic
...
call s:HL('helpHeader', s:palette.cyan, s:palette.none, 'bold')
...
highlight! link CocExplorerFileRootName Cyan
...
highlight! link TagbarScope Cyan
...
highlight! link StartifyNumber Cyan
...
highlight! link agitStatMessage Cyan
